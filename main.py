...
class Login(Screen):
    ...
    def send_recovery_email(self, email):
        ...
        sender_email = "c3rv3r0s07@gmail.com"  # Reemplaza con tu dirección de correo electrónico
        sender_password = "Hozkar.1065581541"  # Reemplaza con tu contraseña de correo electrónico
